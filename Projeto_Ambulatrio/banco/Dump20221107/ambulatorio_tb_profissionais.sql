...
CREATE TABLE `tb_profissionais` (
  ...
  CONSTRAINT `tb_profissionais_ibfk_1` FOREIGN KEY (`fkcontas`) REFERENCES `tb_contas_profissional` (`idcontas`)
...
INSERT INTO `tb_profissionais` VALUES (1,'William caetano de souza','enfermeiro',1,1),(2,'Joao Carlos Santo do Senhor','médico',2,2);
...
-- Dump completed on 2022-11-07 17:32:59
