...
from ficha_atendimento_da_reavaliacao import Ui_Dialog9
import os
...
class Ui_Dialog7(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(100, -15, 611, 61))
        ...
        self.lblErro.setGeometry(QtCore.QRect(650, 11, 110, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">FICHAS DE ATENDIMENTOS PARA REAVALIAÇÃO</span></p></body></html>"))
        self.label_2.setText(_translate("Dialog", "Pesquisar nome do paciente:"))
        self.lblErro.setText(_translate("Dialog", "teste de erro"))
    ...
    def listar_pacientes(self):
        self.resultado = self.banco.recupera_atendidos_e_quantidade_sim()
    ...
    def pesquisa_paciente(self):
        ...
        colunasPesquisada = []
        colunasPesquisada.append("CÓDIGO")
        ...
        colunasPesquisada.append("DATA")
        colunasPesquisada.append("HORA")
        modelPesquisa.setHorizontalHeaderLabels(colunasPesquisada)
        valor = self.cmbNomeAtendido.currentText()
        resposta = self.banco.recupera_paciente_mediante_valor_recebido_sim(valor)
    ...
    def recuperar_paciente(self):
        ...
        dados = self.banco.recuperar_paciente_ja_atendido_sim()
        for dado in dados:
